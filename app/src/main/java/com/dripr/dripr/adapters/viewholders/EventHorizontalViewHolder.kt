...
import kotlinx.android.synthetic.main.event_horizontal_item.view.*


class EventHorizontalViewHolder(inflater: LayoutInflater, parent: ViewGroup) :
    RecyclerView.ViewHolder(inflater.inflate(R.layout.event_horizontal_item, parent, false)) {
